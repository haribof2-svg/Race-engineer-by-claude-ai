...
declare module '$env/static/private' {
	...
	export const EFC_6912_1592913036: string;
	export const HOME: string;
	export const HOMEDRIVE: string;
	export const HOMEPATH: string;
	export const IGCCSVC_DB: string;
	export const INIT_CWD: string;
	export const KEYSHOT12: string;
	export const KEYSHOT_EXTERNAL_LICENSE_FOLDER: string;
	...
	export const SIEMENS_CONNECTOR_INSTALL_PATH: string;
	export const SystemDrive: string;
	export const SystemRoot: string;
	export const TEMP: string;
	export const TMP: string;
	export const TopSolidCommonFiles: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		INIT_CWD: string;
		KEYSHOT12: string;
		KEYSHOT_EXTERNAL_LICENSE_FOLDER: string;
		LOCALAPPDATA: string;
		LOGONSERVER: string;
		NODE: string;
		NODE_ENV: string;
		...
		SIEMENS_CONNECTOR_INSTALL_PATH: string;
		SystemDrive: string;
		SystemRoot: string;
		TEMP: string;
		TMP: string;
		TopSolidCommonFiles: string;
		USERDOMAIN: string;
